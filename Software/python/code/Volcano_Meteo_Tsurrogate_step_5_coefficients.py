...
print("")
print("------------------------------------------------------------------------------")
print("STEP 5: generation of the deterministic coefficients of the gPCE decomposition")
print("------------------------------------------------------------------------------")
print(' ')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
def Volcano_Meteo_Tsurrogate_step_5_coefficients():
	...
	if my_file.is_file():	 
	   ...
	   print("The file: ",my_file," does not exist.")
	   print("Edit and run Volcano_Meteo_Tsurrogate_step_4_format_input.")
	   return
	...
	coeff = np.empty((nvols[0], maxdeg[0]+1), dtype=object)
...
def surrogate_model_gauss_patterson_coeff(param, model, a, b, maxdeg, option):
    ...
    for alpha_norm1 in range(maxdeg+1):        
        ...
        for l in range(alpha.shape[0]):
		    ...
		    # time of arrival treated in second and without log transform
...
if __name__ == '__main__':
    Volcano_Meteo_Tsurrogate_step_5_coefficients()
